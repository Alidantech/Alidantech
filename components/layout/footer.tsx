      ...
      <div className="mx-auto container px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0 text-center md:text-left">
          ...
          <div className="flex flex-col md:flex-row md:space-x-8 justify-center md:justify-start">
            ...
            <Link
              href="https://github.com/Alidantech/organiser"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-muted-foreground hover:text-foreground"
            >
            ...
            <Link
              href="https://github.com/Alidantech/dev-auto"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm text-muted-foreground hover:text-foreground"
            >
          ...
          <p className="mt-8 text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Peter Irungu. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
