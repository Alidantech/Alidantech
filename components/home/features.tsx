...
const features = [
  {
    ...
    description:
      "Mobile developer with experience in building responsive and user-friendly mobile applications.",
    icon: "⚡",
  },
  {
  ...
  },
  {
    title: "UI/UX Design",
    description:
      "UI/UX designer with the ability to create visually appealing and intuitive user interfaces.",
    icon: "✨",
  },
  {
    title: "Data Analysis",
